...
class RestTest {
    ...
    @Nested
    @DisplayName("SignalWireRestError")
    class ErrorTests {

        @Test
        @DisplayName("Error message includes status, method, path")
        void errorMessage() {
            var error = new SignalWireRestError(404, "GET", "/phone_numbers/123", "Not found");
        ...
        void errorProperties() {
            var error = new SignalWireRestError(500, "POST", "/path", "body");
        ...
        void clientError() {
            assertTrue(new SignalWireRestError(400, "GET", "/", "").isClientError());
            assertTrue(new SignalWireRestError(404, "GET", "/", "").isClientError());
            assertTrue(new SignalWireRestError(422, "GET", "/", "").isClientError());
            assertFalse(new SignalWireRestError(500, "GET", "/", "").isClientError());
            assertFalse(new SignalWireRestError(200, "GET", "/", "").isClientError());
        }

        @Test
        @DisplayName("isServerError returns true for 5xx")
        void serverError() {
            assertTrue(new SignalWireRestError(500, "GET", "/", "").isServerError());
            assertTrue(new SignalWireRestError(503, "GET", "/", "").isServerError());
            assertFalse(new SignalWireRestError(404, "GET", "/", "").isServerError());
        }

        @Test
        @DisplayName("isNotFound returns true for 404")
        void notFound() {
            assertTrue(new SignalWireRestError(404, "GET", "/", "").isNotFound());
            assertFalse(new SignalWireRestError(400, "GET", "/", "").isNotFound());
        }

        @Test
        @DisplayName("isUnauthorized returns true for 401 and 403")
        void unauthorized() {
            assertTrue(new SignalWireRestError(401, "GET", "/", "").isUnauthorized());
            assertTrue(new SignalWireRestError(403, "GET", "/", "").isUnauthorized());
            assertFalse(new SignalWireRestError(404, "GET", "/", "").isUnauthorized());
        }
        ...
        void errorWithCause() {
            ...
            var error = new SignalWireRestError(0, "GET", "/path", "msg", cause);
        ...
        void errorTruncatesBody() {
            ...
            var error = new SignalWireRestError(500, "GET", "/", longBody);
        ...
        void errorNullBody() {
            var error = new SignalWireRestError(500, "GET", "/", null);
        ...
        void errorEmptyBody() {
            var error = new SignalWireRestError(500, "GET", "/", "");
            assertNotNull(error.getMessage());
        }
    }
}
