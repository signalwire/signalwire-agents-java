 ...
 */
public class SignalWireRestError extends RuntimeException {
    ...
    public SignalWireRestError(int statusCode, String method, String path, String responseBody) {
    ...
    public SignalWireRestError(int statusCode, String method, String path, String responseBody, Throwable cause) {
